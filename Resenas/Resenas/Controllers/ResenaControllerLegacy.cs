...
//        {
//            Resena resena = new Resena();
//            resena.orderID = optData.orderID;
//            resena.userID = usuario.Id;
//            resena.articleId = optData.articleID;
//            resena.valoration = optData.valoration;
//            resena.content = optData.content;
//            resena.created = DateTime.Now;
//            resena.updated = DateTime.Now;
//            resena.imageUrl = "notengo";
...
//            // Por ejemplo:
//            User usuario = await _verificarToken.obtenerUsuario(token);
//            return usuario;
//        }
...
//            // Verificar el logueo del usuario con el token
//            User usuario = await VerificarLogueo(token);
//            if (usuario == null)
//            {                
...
//            try
//            {
//                Resena resena = MapDataToResenaDtos(resenaDto, usuario);
...
//        [HttpPut]
//        [Route("modificarResena")]
//        public async Task<IActionResult> ModificarResena([FromBody] JsonElement optData, [FromHeader(Name = "Authorization")] string authorization)
//        {
...
//                {
//                    success = true,
//                    message = "La reseña se modificó correctamente",
//                    result = ResenaDto.MapToResenaDto(resena)
//                });
//            }
//            catch (Exception ex)
...
//                    {
//                        success = false,
//                        message = "El ID de la reseña no puede estar vacío"
//                    });
//                }

//                var objectId = ObjectId.Parse(id);

//                bool resultado = _resenaRepository.EliminarResena(objectId);
//                if (resultado)
//                {
//                    return Ok(new
//                    {
